            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-0.5 h-4 w-4 shrink-0 accent-[#C8102E] cursor-pointer"
                />
                <span className="text-xs text-gray-400 leading-relaxed">
                  I consent to receive text messages from LeaseUp Bulldog about my account, leads, and platform updates. Message &amp; data rates may apply. Reply STOP to opt out at any time.
                </span>
              </label>
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                />
                <span className="text-xs text-gray-400 leading-relaxed">
                  I agree to LeaseUp Bulldog&apos;s{" "}
                  <Link href="/terms" className="text-[#C8102E] hover:underline">Terms of Service</Link>{" "}
                  and{" "}
              ...
              <button
                type="submit"
                disabled={loading || !smsConsent || !termsConsent}
