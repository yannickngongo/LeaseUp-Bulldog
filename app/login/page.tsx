        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="relative rounded-2xl border border-[#1E1E2E] bg-[#10101A] p-8">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <div>
                <div className="mb-1.5 flex items-center justify-between">
                  ...
                  <a href="#" className="text-xs text-[#C8102E] hover:underline">Forgot password?</a>
                </div>
                <input
                  type="password"
                  placeholder="••••••••"
            ...
            <p className="mt-6 text-center text-xs text-gray-600">
              ...
              <Link href="/free-trial" className="text-[#C8102E] hover:underline">Start your free trial</Link>
            </p>
          </div>
        </div>
      </div>
