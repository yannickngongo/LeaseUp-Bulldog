          ...
          <div className="relative rounded-2xl border border-[#1E1E2E] bg-[#10101A] p-8">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <div>
                ...
                <input type="text" placeholder="Sunrise Properties LLC" className="w-full rounded-lg border border-[#1E1E2E] bg-[#16161F] px-4 py-3 text-sm text-white placeholder-gray-600 focus:border-[#C8102E] focus:outline-none" />
              </div>
              ...
              <Link
                href="/free-trial"
                className="block w-full rounded-xl bg-[#C8102E] py-3.5 text-center text-sm font-bold text-white hover:bg-[#A50D25] transition-colors mt-2"
              >
                Create Account →
              </Link>
            </form>
            ...
            <button className="mt-4 w-full rounded-xl border border-[#1E1E2E] bg-[#16161F] py-3.5 text-sm font-semibold text-gray-300 hover:border-gray-500 hover:text-white transition-colors flex items-center justify-center gap-2">
